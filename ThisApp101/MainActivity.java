...
public class MainActivity extends AppCompatActivity {
   ...
   private void setStatus(final JSONArray status) {
      ...
      try {
         JSONObject quote = status.getJSONObject((i % 3));
      
         String qouteString = quote.getString("quote");
            ...
            ClickableSpan clickableSpan = 
               new ClickableSpan() {
                  ...
                  public void onClick(View textView) {
                     Toast toastMessage = Toast.makeText(MainActivity.this, "Click the HighLight word " + LOCALCOUNT + " .", Toast.LENGTH_SHORT);
                     toastMessage.show();
                     currentWord++;
                     setStatus(status);
                  }
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      View.OnClickListener ourOnClickListener = 
